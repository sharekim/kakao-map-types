...
export interface IKakaoMaps {
    ...
    MarkerClusterer: new (options?: IKakaoMarkerClustererOptions) => IKakaoMarkerClusterer;
    event: IKakaoEvent;
...
export interface IKakaoServicesGeocoder {
    ...
    pagination: IKakaoServicesPagination) => void, options?: {
        /** 검색할 페이지. 기본값은 1 */
        page?: number;
...
export interface IKakaoServicesPlaces {
    ...
    categorySearch: (
    /** 검색할 카테고리 코드 */
    code: string, callback: (result: any[], 
    /** {@link http://apis.map.kakao.com/web/documentation/#services_Status kakao.maps.services.Status}와 비교하여 사용 */
    status: any, 
    /** {@link http://apis.map.kakao.com/web/documentation/#Pagination kakao.maps.services.Pagenation}의 인스턴스 */
    pagination: IKakaoServicesPagination) => void, options?: {
...
export interface IKakaoDrawingManager {
     ...
     * {@link http://apis.map.kakao.com/web/sample/drawingGetData drawing Library에서 데이터 얻기 샘플보기}
     */
    getData: (types?: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType][]) => {
        [shape: string]: any;
    };
    /**
     ...
     */
    getOverlays: (types?: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType][]) => {
        [shape: string]: any;
    };
    /**
    ...
    addListener(type: "select", callback: (e: {
    ...
    addListener(type: "cancel", callback: (e: {
        overlayType: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType];
    }) => void): void;
    addListener(type: "remove", callback: (e: {
        overlayType: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType];
    }) => void): void;
    /**
    ...
    removeListener(type: "select", callback: (e: {
        overlayType: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType];
    }) => void): void;
    ...
    removeListener(type: "cancel", callback: (e: {
        overlayType: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType];
    }) => void): void;
    removeListener(type: "remove", callback: (e: {
        overlayType: IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType];
    }) => void): void;
...
export declare type TKakaoDrawingOverayTypeValue = IKakaoDrawingOverayType[keyof IKakaoDrawingOverayType];
...
export declare type TKakaoEventTarget = IKakaoMap | IKakaoRoadview | IKakaoMarker | IKakaoPolyline | IKakaoPolygon | IKakaoCircle | IKakaoEllipse | IKakaoRectangle;
export declare type TKakaoEventType<Target extends TKakaoEventTarget> = Target extends IKakaoMap ? "zoom_start" | "zoom_changed" | "bounds_changed" | "idle" | "tilesloaded" | "maptypeid_changed" | "click" | "dbclick" | "rightclick" | "mousemove" | "dragstart" | "drag" | "dragend" : Target extends IKakaoRoadview ? "init" | "panoid_changed" | "viewpoint_changed" | "position_changed" : Target extends IKakaoMarker ? "click" | "mouseover" | "mouseout" | "rightclick" | "dragstart" | "dragend" : Target extends IKakaoPolyline ? "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" : Target extends IKakaoPolygon ? "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" : Target extends IKakaoCircle ? "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" : Target extends IKakaoEllipse ? "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" : Target extends IKakaoRectangle ? "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" : never;
export declare type TKakaoEventHandler<Target extends TKakaoEventTarget, Type extends TKakaoEventType<Target>> = Target extends IKakaoMap ? Type extends "zoom_start" | "zoom_changed" | "bounds_changed" | "idle" | "tilesloaded" | "maptypeid_changed" ? () => void : Type extends "click" | "rightclick" | "dbclick" | "mousemove" | "dragstart" | "drag" | "dragend" ? (e: IKakaoMouseEvent) => void : never : Target extends IKakaoRoadview ? Type extends "init" | "panoid_changed" | "viewpoint_changed" | "position_changed" ? () => void : never : Target extends IKakaoMarker ? Type extends "click" | "mouseover" | "mouseout" | "dragstart" | "dragend" | "rightclick" ? (e: IKakaoMouseEvent) => void : never : Target extends IKakaoPolyline ? Type extends "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" ? (e: IKakaoMouseEvent) => void : never : Target extends IKakaoPolygon ? Type extends "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" ? (e: IKakaoMouseEvent) => void : never : Target extends IKakaoCircle ? Type extends "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" ? (e: IKakaoMouseEvent) => void : never : Target extends IKakaoEllipse ? Type extends "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" ? (e: IKakaoMouseEvent) => void : never : Target extends IKakaoRectangle ? Type extends "mouseover" | "mouseout" | "mousemove" | "mousedown" | "click" ? (e: IKakaoMouseEvent) => void : never : never;
...
export declare type TKakaoBaseMapTypeIdKey = keyof IKakaoBaseMapTypeId;
export declare type TKakaoBaseMapTypeIdValue = IKakaoBaseMapTypeId[keyof IKakaoBaseMapTypeId];
...
export declare type TKakaoOverayMapTypeIdKey = keyof IKakaoOverayMapTypeId;
export declare type TKakaoOverayMapTypeIdValue = IKakaoOverayMapTypeId[keyof IKakaoOverayMapTypeId];
export interface IKakaoMapTypeId extends IKakaoBaseMapTypeId, IKakaoOverayMapTypeId {
}
export declare type TKakaoMapTypeIdValue = IKakaoMapTypeId[keyof IKakaoMapTypeId];
export declare type TKakaoMapTypeIdKey = keyof IKakaoMapTypeId;
export interface IKakaoCopyrightPosition {
    BOTTOMLEFT: 0;
    BOTTOMRIGHT: 1;
}
export declare type TKakaoCopyrightPosition = IKakaoCopyrightPosition[keyof IKakaoCopyrightPosition];
export declare type TKakaoStrokeStyles = "solid" | "shortdash" | "shortdot" | "shortdashdot" | "shortdashdotdot" | "dot" | "dash" | "dashdot" | "longdash" | "longdashdot" | "longdashdotdot";
